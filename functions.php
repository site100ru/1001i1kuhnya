							...
							<div class="col">
								...
								<div class="row justify-content-center">
									<div class="col-md-6 mt-5">
										...
										<p>Период проведения акции: 01.11.2025 – 31.12.2025.</p>
										<p>В акции участвует весь ассортимент крупной бытовой техники бренда KÖRTING (отдельностоящая и встраиваемая). Не участвуют отдельностоящие микроволновые печи и малая бытовая техника.</p>
										<p>Подарки предоставляются:</p>
										<ol>
											<li>При покупке комплекта техники KÖRTING, состоящего из трёх приборов – в подарок предоставляется встраиваемая посудомоечная машина KDI 45140/60110 или микроволновая печь KMI 820 (GSCW, GNBX). В комплект обязательно должен входить духовой шкаф.</li>
											<li>При покупке комплекта из четырёх приборов — в подарок предоставляется узкая стиральная машина с паром KWM 45IS148. В комплект обязательно должен входить духовой шкаф.</li>
											4. Все приборы в комплекте должны быть из различных товарных категорий актуального ассортимента KÖRTING.
											5. Скидки суммируются с промо-ценами на выделенный ассортимент, действующими в этот период.
											6. Организатор оставляет за собой право на досрочную остановку акции и изменение её сроков.
											7. Все приборы в комплекте должны соответствовать актуальному ассортименту KÖRTING.
											<li>Механика:
												<ul>
													<li>Действует дополнительная возможность получения другого прибора в пределах категории из доступного ассортимента с доплатой разницы в РРЦ ( с учетом промо 1), по согласованию.<strong>Скидка&#160;20%</strong> на комплект техники LEX из 3 приборов. Обязательно одним из приборов в комплекте должен быть духовой шкаф. Позиции в комплекте должны быть из разных товарных групп. В акции не участвуют товары из категории МБТ, в том числе соло СВЧ, и угольные фильтры.<li>
												</ul>
											</li>
										</ol>
									</div>
