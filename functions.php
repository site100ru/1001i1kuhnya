								...
								<div class="row justify-content-center">
									<div class="col-md-6 mt-5">
										...
										<ol>
											...
											<li>Механика:
												<ul>
													<li>Действует дополнительная возможность получения другого прибора в пределах категории из доступного ассортимента с доплатой разницы в РРЦ ( с учетом промо 1), по согласованию.<li>
												</ul>
											</li>
										</ol>
									</div>
