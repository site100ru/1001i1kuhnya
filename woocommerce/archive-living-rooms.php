...
<!-- Header parallax -->
<header>
	<div class="parallax-2 header-archive-living-rooms"></div>
	<div class="container"> <!-- container/container-fluid -->
		<div class="row justify-content-center align-items-center"> <!-- min-height: 75vh; -->
			<div class="col text-light py-5"> <!-- text-center -->
				...
				<!-- Subtitle -->
				<h2 class="text-md-center home-subtitle mb-3 mb-md-4">Готовые и на заказ</h2>
				<!-- Header advantages -->
...
<section id="quiz" class="py-5">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col">
				<h2 class="text-uppercase text-center text-corporation-orange fw-bold">Ответьте на несколько вопросов ниже<br>и узнайте предварительную стоимость Вашей гостиной</h2>
				<div class="title-line mb-5"></div>
				<div class="row justify-content-center">
					
					<!-- ВЛПРОСЫ ПО ДРУГОЙ МЕБЕЛИ -->
					<div class="col-12" id="2-3">
						<h3 class="text-center mb-5">Для расчета стоимости опишите Вашу гостиную</h3>
