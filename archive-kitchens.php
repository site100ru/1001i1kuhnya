							...
							if ( woocommerce_product_loop() ) {
								...
								if ( wc_get_loop_prop( 'total' ) ) {
									while ( have_posts() ) {
										...
										wc_get_template_part( 'content', 'product-kitchens' );
...
<section class="action-4-section bg-light py-5">
	<div class="container"> <!-- container/container-fluid -->
		<div class="row justify-content-center">
			<div class="col">
				<h2 class="text-uppercase text-center text-corporation-orange fw-bold mb-2">Наши акции</h2>
				<p class="section-sutitle text-center mb-4">Заказывайте и покупайте кухню выгодно!</p>
				<div class="row justify-content-center">
					<div class="col-md-6 mt-5">
						<img src="<?php echo get_template_directory_uri(); ?>/images/actions/action-1.webp" class="w-100 mb-4 rounded shadow">
						<p class="fs-5 fw-light">При заказе кухни - честная <strong>скидка &#160;5%!</strong> при 100% оплате.</p>
					</div>
					<div class="col-md-6 mt-5">
						<img src="<?php echo get_template_directory_uri(); ?>/images/actions/action-melkaya-bytovay-technics.webp" class="w-100 mb-4 rounded shadow">
						<p class="fs-5 fw-light">При заказе кухни от 50 000 рублей - мелкая бытовая техника <strong>в&#160;подарок!</strong></p>
					</div>
					<div class="col-md-4 mt-5">
						<img src="<?php echo get_template_directory_uri(); ?>/images/actions/action-5.webp" class="w-100 mb-4 rounded shadow">
						<p class="fs-5 fw-light">Нашим клиентам <strong>оплачиваем парковку</strong> в&#160;ТЦ&#160;"Малина"</p>
					</div>
					<div class="col-md-4 mt-5">
						<img src="<?php echo get_template_directory_uri(); ?>/images/actions/action-4.webp" class="w-100 mb-4 rounded shadow">
						<p class="fs-5 fw-light">При заказе кухни <strong>скидка до&#160;35%!</strong></p>
					</div>
					<div class="col-md-4 mt-5">
						<img src="<?php echo get_template_directory_uri(); ?>/images/actions/action-3.webp" class="w-100 mb-4 rounded shadow">
